<div class="container">
  <div class="row">
    <div class="btn-group" role="group" >
      ...
      <a href="/ventasPorPeriodo" class="btn btn-default cboxElement" id="buttonPeriodicSellings">Ventas por período</a>
      <a href="/promocion" class="btn btn-default cboxElement" id="buttonPromotions">Promociones</a>
      <a href="/reporteDeInventario" class="btn btn-default cboxElement" id="buttonIntentoryReport">Reporte de inventario</a>
